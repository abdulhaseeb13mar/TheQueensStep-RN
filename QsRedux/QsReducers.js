...
const QsCartReducer = (st = cart, action) => {
...
const QsUserReducer = (st = userState, action) => {
  switch (action.type) {
...
const QsCrntPrdtReducer = (state = crntPrdtState, action) => {
  switch (action.type) {
...
const QsToggleFav = (state = FavItems, action) => {
  switch (action.type) {
